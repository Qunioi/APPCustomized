<template>
  <header class="header-wrap">
    <div class="header-logo">
      <a href="/"><svg class="header-logo-image" width="112" height="42" viewBox="0 0 112 42" fill="none" xmlns="http://www.w3.org/2000/svg">
...
import { computed, inject } from 'vue' // 加入 inject
