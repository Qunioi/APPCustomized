<template>
  <header class="header-wrap">
    <div class="header-logo">
      <svg class="header-logo-image" width="112" height="42" viewBox="0 0 112 42" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="header-navigation">
      <nav class="header-navigation-menu">
        <a class="header-navigation-item header-navigation-item--active" href="#">版型选择</a>
        <a class="header-navigation-item" href="#">ICON样式</a>
        <a class="header-navigation-item" href="#">游戏介接</a>
        <a class="header-navigation-item" href="#">常见问题</a>
      </nav>
    </div>
    <div class="header-feedback">
      <button class="header-feedback-btn">
