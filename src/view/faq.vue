<template>
  <div class="page-wrap">
    ...
    <div class="gotop-wrap">
      <Transition name="go-top" appear>
        <button
          v-show="showGoTop"
          class="gotop-btn"
          @click="scrollToTop">
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 2L7 7L8.41 8.41L11 5.83V22H13V5.83L15.59 8.41L17 7L12 2Z" fill="currentColor"/>
          </svg>
        </button>
      </Transition>
    </div>
          ...
          <div class="faq-wrap">
            <ul class="faq-list">
              ...
              <li>
                ...
                <div class="faq-content">A：时程会依调整范围、同阶段案件量与系统模组化程度有所差异。<br>在您提供完整需求后，平均约需 15 个工作天 完成。<br>待确认合作范畴与详细需求后，我们将提供正式排程并与您保持进度同步。</div>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="faq-wrap">
            <ul class="faq-list">
              ...
              <li>
                ...
                <div class="faq-content">A：时程将依内容复杂度、系统模组化程度与同时间需求量调整。<br>在确认完整需求后，平均约需 35 个工作天 完成。<br>正式时程将于评估需求后提供，并全程由专案窗口陪伴您推动进度。</div>
              </li>
              <li>
      ...
      <details class="page-details">
        ...
        <div class="page-content">
          <div class="faq-wrap">
            <ul class="faq-list">
              <li>
                <div class="faq-title">Q1：我要如何创立我要的APP站？</div>
                <div class="faq-content">A：我们目前提供 四款专业设计版型，可于网站上即时预览效果，并选择最符合您品牌形象与需求的版型，作为专案的设计基础。</div>
              </li>
              <li>
...
import FaqTooltip from '@/components/FaqTooltip.vue'
